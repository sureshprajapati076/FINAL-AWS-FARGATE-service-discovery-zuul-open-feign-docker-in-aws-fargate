...
import com.example.config.aws.Container;
import com.example.config.aws.Converter;
import com.example.config.aws.EcsTaskMetadata;
import com.example.config.aws.Network;
